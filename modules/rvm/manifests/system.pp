class rvm::system($version=undef) {
  ...
  exec { 'system-rvm':
    ...
    command => "bash -c 'gpg2 --keyserver hkp://keys.gnupg.net --recv-keys D39DC0E3 && \
                /usr/bin/curl -s https://raw.githubusercontent.com/wayneeseguin/rvm/master/binscripts/rvm-installer -o /tmp/rvm-installer && \
